...
hljs.LANGUAGES.java = function(a) {
	return {
		k: {
			keyword: "false synchronized int abstract float private char boolean static null if const for true while long throw strictfp finally protected import native final return void enum else break transient new catch instanceof byte super volatile case assert short package default double public try this switch continue throws",
			built_in: "DefaultMediaPlayer MediaPlayer MediaResource"
		},
		c: [{
			cN: "javadoc",
			b: "/\\*\\*",
...
hljs.LANGUAGES.actionscript = function(a) {
	...
	return {
		k: {
			...
			built_in: "MediaPlayerItem AdvancedMediaPlayer"
		},
