...
<?php echo $this->Form->create('ShotType'); ?>
	<fieldset>
		<legend><?php echo __('Edit Shot Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ShotType.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ShotType.id'))); ?></li>
